...
import com.mini.rpc.common.MiniRpcMessage;
...
public class MiniRpcDecoder extends ByteToMessageDecoder {
    ...
    */
    ...
    public final void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        MsgType msgTypeEnum = MsgType.findByType(msgType); //查找相应的信息类型
        if (msgTypeEnum == null) {
            return;
        }
        ...
        switch (msgTypeEnum) {
            ...
            case HEARTBEAT_RESPONSE:
                MiniRpcMessage message = rpcSerialization.deserialize(data, MiniRpcMessage.class);
                if (message!=null){
